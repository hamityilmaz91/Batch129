  ...
  Örn:  Hangi Kahveyi İstersiniz?  1.Türk kahvesi  2.Filtre Kahve  3.Espresso
   ...
   //
       todo 3.Koşul Bölümü
        ...
        todo if(){        Eğer String seker   Evet e eşitse ,  sistem bize "Kaç şeker olsun?" sorusunu sormalı.
     ...
     (ipucu: Bu kodların heosi if bloğunun içerisinde olacak)
        ...
        (String bosKod = sc.nextLine();    )
         dummy kod ekleyiniz.
        Sistem bize "Hangi boyutta olsun?
      ...
      (büyük küçük harf duyarlılıgı olmamalı. yani kullanıcı büyük boy veya BüYüK Boy girdiginde kabul etmeli.
        ...
        Türk Kahvesi orta boy hazırdır.
        Afiyet olsun !!! (Türk kahvesi için String hangiKahveyi kullanın.     orta boy için de String boyut ' u kullanın.)
        todo Açıklama :

        Projeyi bilerek biraz zor hazırladık.
        Üzerinde fazla fazla kafa yormanız ve "grupça çalışmanız için" böyle düzenledik.
